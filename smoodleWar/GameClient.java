...
public class GameClient extends AbstractClient
{
	...
	// Private data fields for storing the GUI controllers.
	  ...
	  protected void handleMessageFromServer(Object arg0) {
		...
		//Check returned string to determine what actions need to be taken based on the status
		//of the project
		...
		//For word prompts, the server should return an array of strings. This response is built
