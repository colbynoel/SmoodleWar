...
public class DeleteAccountPanel extends JPanel {
	...
	public DeleteAccountPanel(DeleteAccountControl cac) {

		// Create a panel for the labels at the top of the GUI.
		JPanel labelPanel = new JPanel(new GridLayout(3, 1, 5, 5));
		errorLabel = new JLabel("", JLabel.CENTER);
		errorLabel.setForeground(Color.RED);
		JLabel instructionLabel = new JLabel("Enter the username and password of the account to delete.", JLabel.CENTER);
		JLabel instructionLabel2 = new JLabel("!!!ONCE SUBMIT IS PRESSED THIS CANNOT BE UNDONE!!!", JLabel.CENTER);
